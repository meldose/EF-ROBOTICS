...
POLL_SEC           = 0.5
ARRIVE_DIST_M      = 0.50
ROW_GATE_DWELL_SEC = 15.0
PRE_PULSE_DWELL_S  = 15.0
POST_PULSE_DWELL_S = 10.0
...
# class RowSpec:
#     __slots__ = ("pickup","drop","wrapper","use_wrapper")
#     def __init__(self, pickup: Dict[str,Any], drop: Dict[str,Any], wrapper: Optional[Dict[str,Any]], use_wrapper: bool):
#         self.pickup = pickup
#         self.drop = drop
...
app.layout = dbc.Container([
    dbc.Card(dbc.CardBody([
        dbc.Row([
            ...
            dbc.Col(dbc.Input(id="robot-id", value=DEFAULT_ROBOT_ID, placeholder="robotId", n_submit=0, type="text"),
                    width=4),
            dbc.Col(dbc.Button("Load robot", id="btn-load", color="secondary"), width="auto"),
    ...
    dbc.Button("Cancel current & go Standby", id="btn-cancel", color="danger", className="my-3"),
...
def handle_actions(n_start, n_cancel, rstate, *state):
    global RUNNER
